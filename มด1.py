...
╠🍁➣ tag1:  =ไส่ข้อความคนแทก
╠🍁➣ tag2:  =ไส่ข้อความคนแทก2
╚══════════════════
╔══════════════════
...
╠🍁➣ tag1  = เช็คข้อความคนแทกแบบ1
╠🍁➣ tag2  = เช็คข้อความคนแทกแบบ2
╚══════════════════
✥==================================✥"""
helpMessage4 ="""
╔══════════════
            ...
            if mid in op.param3:
                ...
                if wait["autoJoin"] == True:
                    if wait["autoCancel"]["on"] == True:
                        ...
                        cl.sendText(op.param1, "ติดเซลคับ\nรบกวนส่งลิ่งมาส่วนตัว\n[🔥ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ🔥]\nถ้าอยากไห้เข้าส่งมาเลย\nhttp://line.me/ti/p/~antmod.")
                    else:
                        cl.acceptGroupInvitation(op.param1)
                        cl.sendText(op.param1, "ติดเซลคับ\nรบกวนส่งลิ้งมาส่วนตัว\n[🔥ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ🔥]\nยังอยากไห้เข้าส่งลิ้งมานะ\nhttp://line.me/ti/p/~antmod.")
