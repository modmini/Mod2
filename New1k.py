...
cl = LINETCR.LINE()
cl.login(token="EpU7CE63i5NfETlWPbMc.V3kAEMTUz4tuU1pj+ELiFa.WRLsAjybf09d/khNLshJgQ2B2R2yv8Scg4bGuQ6yNTE=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["ubf729a7a6b6e6784d4bb53c9fde9487c",mid]
self = ["ubf729a7a6b6e6784d4bb53c9fde9487c",mid]
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"ครับมินไม่ว่างคุยสาวอยู่...")
